<template>
    <div>
		<el-card style="margin-bottom: 15px;">
			<div slot="header">
			   <span class="el-icon-menu text-primary"></span> 科室列表
			</div>
			<div>
			   				...
			   				<div @click="showDoctorWin(item.id)"  class="dept-panle">
			   					...
			   					<div class="dept-info">
			   						<div class="doctor-info-item">
			   							...
			   							<span class="dept-info-title">{{ item.did }}</span>
			   						</div>
			   					</div>
	   ...
	   <el-dialog title="挂号预约" width="600px" :visible.sync="showRegistFlag">
			<el-form label-width="90px" :model="registForm">
				<el-form-item label="挂号费用">
					<el-input v-model="registForm.total" disabled
						placeholder="请输入挂号费用…" autocomplete="off"></el-input>
				</el-form-item>
				<el-form-item label="预约时间">
					<el-date-picker style="width: 100%;"
					      v-model="registForm.registeTime"
    ...
    methods: {
		...
		showRegisteWin(info){
			...
			if(this.registForm.token){
				...
				this.registForm.total = info.registerFee;
