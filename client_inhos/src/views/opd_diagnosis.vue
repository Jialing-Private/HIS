	...
	<div class="diagnosis-body">
			...
			<el-col :span="8" gutter="15">
				<div class="patient-info-panel">
					...
					<div v-if="onePatient">
						...
						<div class="patient-info-details">姓名: {{onePatient.name}}</div>
					...
					<el-empty v-else description="队列中暂无病人" class="patient-empty"></el-empty>
				</div>
			</el-col>
		</div>
		...
		<div>
			<el-dialog title="开具住院单" :visible.sync="showSentHosFlag" class="sent-to-hospital-diag">
		    	...
		    	<el-row>
		    		<el-form :inline="true" :model="inHosLog" ref="inHosLog" class="pres-form-inline">
		    			<el-form-item label="住院科室" class="one-pres-item">
							<el-input v-model="inHosLog.inHosDept" placeholder="科室名称" class="one-pres-input"></el-input>
						</el-form-item>
		    			<el-form-item label="负责医生" class="one-pres-item">
							<el-input v-model="inHosLog.startDoctorName" placeholder="医生姓名" class="one-pres-input"></el-input>
						</el-form-item>
					</el-form>
		    	</el-row>
...
export default {
	...
	methods: {
		...
		fixCheckForm(){
			...
			for (var i = 0; i < this.checkForm.medicine_forms.length; i++){
